...
func init() {
	i18n.Register("wework",
		"en", i18n.Dict{
			"context":        "Current message is from WeWork. Use the FILE_UPLOAD tool to upload and send files/images. WeWork markdown does not support inline images. After uploading, images will be sent as native image messages.",
		...
		"zh", i18n.Dict{
			"context":        "当前消息来自企业微信。请使用 FILE_UPLOAD 工具上传和发送文件/图片。企业微信 markdown 不支持内嵌图片，上传图片后工具会自动以原生图片消息发送到会话。",
